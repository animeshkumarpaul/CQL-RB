...
Usage Notes:
------------
This file is intended for use in offline RL experiments on biased healthcare datasets using the EpiCare framework.
...
class TrainConfig:
    ...
    checkpoints_path: Optional[str] = "./algorithms/CQL_rb/checkpoints_" # Save path
...
def maximum_mean_discrepancy_loss(X_treat, X_control):
    """
    Computes Maximum Mean Discrepancy (MMD) loss between treated and control representation distributions.
    Reference: Shalit et al., 2016 (for IPM-based domain balancing in ITE).
    """
